  ...
  return (
    <>
      <div
        ...
        className="main-container flex flex-col-reverse lg:flex-row items-center justify-center p-5 lg:p-10 mt-48 md:mt-0"
      >
        <div className="w-full flex justify-center text-white p-5 lg:w-1/2">
          <div className="text-center lg:text-left space-y-5 lg:space-y-3">
            ...
            <p className="overflow-hidden font-serif text-base lg:text-lg leading-relaxed lg:leading-relaxed">
              ...
              expertise lies in creating responsive front-end interfaces,
              designing robust back-end systems, and managing databases
              efficiently.
              <br />
              In addition to my technical skills, I thrive in collaborative
              environments where I can work closely with designers and
              stakeholders to deliver exceptional user experiences. Let&apos;s
        ...
        >
          <FontAwesomeIcon icon={faYoutube} className="text-2xl text-white" />
            ...
            <div className="p-2 pl-0 flex justify-center lg:justify-start gap-4">
              {/* Contact Button */}
              <button
